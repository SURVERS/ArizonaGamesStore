...
const PRICE_CONFIG = {
  'Продать': {
    'VC': { min: 100000, max: 10000000000, period: null },
    '$': { min: 1000000, max: 300000000000, period: null },
    'BTC': { min: 100, max: 3000000, period: null },
    'EURO': { min: 10000, max: 130000000, period: null }
  },
  'Купить': {
    'VC': { min: 100000, max: 10000000000, period: null },
    '$': { min: 1000000, max: 300000000000, period: null },
  ...
  'Сдать в аренду': {
    'VC': { min: 100000, max: 5000000, period: 'час' },
    '$': { min: 1000000, max: 300000000, period: 'час' },
    'BTC': { min: 100, max: 30000, period: 'час' },
    'EURO': { min: 10000, max: 200000, period: 'час' }
  },
  'Поиск Заместителя': {
    'VC': { min: 100000, max: 5000000, period: 'сутки' },
    '$': { min: 1000000, max: 300000000, period: 'сутки' },
    'BTC': { min: 100, max: 30000, period: 'сутки' },
    'EURO': { min: 10000, max: 200000, period: 'сутки' }
  }
};
...
function Security() {
  ...
  useEffect(() => {
    document.title = 'Arz Store | Безопасность';
  }, []);
  ...
  const fetchAds = async (currentOffset) => {
    ...
    try {
      ...
      let url = `http://localhost:8080/api/ads?category=security&server=${selectedServer}&limit=20&offset=${currentOffset}`;
  ...
  const fetchAdCount = async () => {
    try {
      const response = await fetch('http://localhost:8080/api/getadcount?CategoryName=security');
      const data = await response.json();
  ...
  const handleCreateListing = async () => {
    ...
    const imagePath = `ads/${formData.category || 'security'}/${timestamp}_${user?.nickname || 'user'}.${fileExtension}`;
    ...
    formDataToSend.append('category', 'security');
          ...
          <div className="listing-form">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleInputChange}
                maxLength={25}
                placeholder="Например: Охранник 10 lvl"
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                maxLength={500}
                placeholder="Опишите охранника подробнее..."
    ...
    <div className="mobile-category-page">
      ...
      <div className="mobile-category-content">
        <div className="mobile-category-header">
          ...
          <h1 className="mobile-category-title">Охранники</h1>
        </div>
                ...
                <div key={ad.id} className="mobile-listing-card">
                  ...
                  <div className="mobile-listing-content">
                    ...
                    <button
                      ...
                      onClick={() => ad.type === 'Сдать в аренду' ? handleOpenRental(ad) : null}
                    >
