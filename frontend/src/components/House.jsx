...
const PRICE_CONFIG = {
  'Продать': {
    'VC': { min: 500000, max: 50000000000, period: null },
    '$': { min: 5000000, max: 1500000000000, period: null },
    'BTC': { min: 500, max: 15000000, period: null },
    'EURO': { min: 50000, max: 650000000, period: null }
  },
  'Купить': {
    'VC': { min: 500000, max: 50000000000, period: null },
    '$': { min: 5000000, max: 1500000000000, period: null },
  ...
  'Сдать в аренду': {
    'VC': { min: 250000, max: 25000000, period: 'час' },
    '$': { min: 2500000, max: 1500000000, period: 'час' },
    'BTC': { min: 250, max: 150000, period: 'час' },
    'EURO': { min: 25000, max: 1000000, period: 'час' }
  }
};
...
function House() {
  ...
  useEffect(() => {
    document.title = 'Arz Store | Недвижимость';
  }, []);
  ...
  const fetchAds = async (currentOffset) => {
    ...
    try {
      ...
      let url = `http://localhost:8080/api/ads?category=house&server=${selectedServer}&limit=20&offset=${currentOffset}`;
  ...
  const fetchAdCount = async () => {
    try {
      const response = await fetch('http://localhost:8080/api/getadcount?CategoryName=house');
      const data = await response.json();
  ...
  const handleCreateListing = async () => {
    ...
    const imagePath = `ads/house/${timestamp}_${user?.nickname || 'user'}.${fileExtension}`;
    ...
    formDataToSend.append('category', 'house');
          ...
          <div className="listing-form">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleInputChange}
                maxLength={25}
                placeholder="Например: Дом 10 класс"
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                maxLength={500}
                placeholder="Опишите дом подробнее..."
    ...
    <div className="mobile-category-page">
      ...
      <div className="mobile-category-content">
        <div className="mobile-category-header">
          ...
          <h1 className="mobile-category-title">Дома</h1>
        </div>
